...
typedef int8_t (*IWriteParam)(uint16_t address, int8_t *value, uint16_t len_register);
typedef int16_t (*IReadParam)(uint16_t address);
typedef int8_t (*IAddressCheck)(uint16_t address, uint16_t FN_CODE_x);
...
typedef struct{
	...
	int8_t (*IParamWrite)(uint16_t address, int8_t *value, uint16_t len_register);
	int16_t (*IParamRead)(uint16_t address);

	int8_t (*IParamAdressCheck)(uint16_t address, uint16_t FN_CODE_x);
}ModbusPDU_t;
